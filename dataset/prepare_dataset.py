...
def split_train_vald(zip_path, train_dir, val_dir):
    with zipfile.ZipFile(zip_path, "r") as zip_file:
        # Get a list of all image files in the ZIP archive
        file_list = [f for f in zip_file.namelist() if f.endswith(".jpg")]
...
# annot_zip = download(COCO_URLS["annotations"], ANNOTATIONS_DIR)

test_folder = extract_zip(test_zip, TEST_DIR)

print("Moving files to train, val, and test directories...")
train_folder, val_folder = split_train_vald(train_zip, TRAIN_DIR, VAL_DIR)
